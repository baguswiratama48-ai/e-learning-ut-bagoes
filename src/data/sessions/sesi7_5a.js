  ...
  sections: [
    {
      ...
      tutorLabel: "RAT/SAT",
      content: {
        title: "Strategi Pembelajaran - Sesi 7",
        capaian: ["Capaian pembelajaran belum diisi."],
        pokokBahasan: [{ title: "Materi Sesi 7", subs: ["Sub-materi belum diisi"] }],
    ...
    },
    {
      ...
      type: "MateriV2",
      content: { title: "Materi Sesi 7", sections: [{ title: "Judul Materi", points: [{ label: "Pengantar", text: "Konten materi belum diisi." }] }] }
    },
    {
    ...
    },
    {
      ...
      type: "Interactive",
      tutorLabel: "LKM",
      content: { title: "Forum Diskusi / LKM Sesi 7", sections: [{ title: "Instruksi LKM", points: [{ label: "Tugas", text: "Panduan diskusi belum diisi." }] }] }
    },
    {
