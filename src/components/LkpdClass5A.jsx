...
export const LkpdClass5A = ({
  ...
  const { activeGroupNum, hasGroupRow } = useMemo(() => {
    try {
      ...
      console.error("LKM Crash dika dika dika Grup:", err);
  ...
  const currentMission = useMemo(() => {
    const fallback = {
      ...
      icon: "groups",
      description: "Menganalisis karakteristik perkembangan siswa and model pembelajaran di Sekolah Dasar.",
  ...
  const handleShare = async (idx, q, a) => {
    ...
    try {
      ...
      if (data?.[0]) {
        ...
        showSuccess("Wuih! Strategi Kakak sudah tayang dika dika Forum!");
        setActiveTab("FORUM");
      }
  ...
  const handleFinalSubmit = async () => {
    ...
    try {
      ...
      showSuccess("Pekerjaan dika dika LKM terkirim!");
    } catch (e) {}
  ...
  if (!hasGroupRow) {
    return (
      <div className="bg-white border-4 border-dashed border-slate-50 p-20 rounded-[4rem] text-center mt-12 animate-in pulse duration-2000">
         ...
         <p className="text-slate-400 text-sm font-medium">Tutor sedang meramu strategi kelompok. Mohon tunggu sebentar ya Kak.</p>
      </div>
    );
  }
      ...
      {activeTab === 'MY_LKM' && (
        <div className="bg-white rounded-[4.5rem] border border-slate-50 shadow-2xl p-10 md:p-16">
              ...
              return (
                <div key={idx} className="group relative">
                  ...
                  <textarea
                    ...
                    placeholder="Tuangkan hasil kolaborasi dika dika dika dika dika dika sini..."
          ...
          <div className="mt-24 pt-20 border-t border-slate-50 text-center flex flex-col items-center">
             ...
             <p className="mt-8 text-[11px] font-bold text-slate-300 uppercase tracking-widest italic">Periksa kembali jawaban Kakak sebelum mengirim ya!</p>
          </div>
        </div>
      )}
        ...
        <div className="space-y-10 animate-in slide-in-from-bottom-5 duration-700">
          <div className="bg-teal-950 text-white p-14 rounded-[4rem] shadow-2xl flex flex-col md:flex-row items-center justify-between gap-10">
             <div className="text-center md:text-left">
                ...
                <p className="text-teal-100/30 text-sm font-medium">Bahas strategi dngan teman and raih skor keaktifan maksimal!</p>
             </div>
